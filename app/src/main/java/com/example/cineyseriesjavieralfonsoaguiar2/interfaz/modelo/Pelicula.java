package com.example.cineyseriesjavieralfonsoaguiar2.interfaz.modelo;
...
public class Pelicula implements Serializable {
    ...
    public Pelicula(int imagenId, String director, String nombre, String protagonista,
            ...
            int duracionMin, boolean favorito, boolean estaVista, float nota) {
